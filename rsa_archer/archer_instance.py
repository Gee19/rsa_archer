...
class ArcherInstance:
    ...
    def get_users(self, params=""):
        ...
        try:
            response = requests.post(api_url, headers=self.header, verify=CA_CERTS_FILE)
    ...
    def get_subform_fields_by_id(self, sub_form_id):
        """
        :param sub_form_id: Gets from parent application field ("RelatedValuesListId").
            - Note: I was only interested in text fields and attachments
    ...
    def get_value_id_by_field_name_and_value(self, field_name, value):
        ...
        try:
            ...
            log.error(
                "Function get_value_id_by_field_name_and_value didn't work, %s", e
            )
    ...
    def create_content_record(self, fields_json, record_id=None):
        ...
        try:
            if record_id:
                ...
                data = json.loads(response.content)
                log.info(
                    "Function create_content_record created record, %s",
                    data["RequestedObject"]["Id"],
                )
    ...
    def create_sub_record(self, fields_json, subform_name):
        ...
        try:
            ...
            log.info(
                "Function create_sub_record created record, %s",
                data["RequestedObject"]["Id"],
            )
    ...
    def delete_record(self, record_id=None):
        ...
        try:
            ...
            log.info("Function delete_content_record didn't work, %s", e)
    ...
    def post_attachment(self, name, base64_string):
        ...
        try:
            ...
            log.error(
                "Function post_attachment didn't work, %s; Response content: %s",
                e,
                response.content,
            )
    ...
    def get_record_id_by_unique_value(self, key_value_field):
        ...
        try:
            ...
            log.info(f"get_record_id_by_unique_value failed with exception {e}")
            return False
